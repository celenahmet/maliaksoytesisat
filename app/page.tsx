...
const copy = {
  ...
  en: {
    ...
    footerSlogan: "Dependable technical support for your home.", footerText: "Fast and careful solutions for electronics, small appliances, boilers, radiators and plumbing.", ourServices: "Our Services", contactUpper: "CONTACT", serviceArea: "On-site service throughout Ankara.", rights: "All Rights Reserved.", backTop: "BACK TO TOP",
