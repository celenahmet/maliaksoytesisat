...
const serviceCatalog = [
  {
    id: "electronics", slug: "elektronik-tamir", no: "01", image: "/assets/cards/01.webp", width: 1536, height: 1024, icon: Tv,
    tr: { tag: "ELEKTRONİK", title: "Elektronik Arıza & Tamir", text: "Televizyon, uydu alıcısı, ses sistemleri ve daha fazlasında bakım ve onarım.", issues: ["Televizyon arızası", "Uydu alıcısı arızası", "Ses sistemi arızası", "Diğer elektronik arıza"] },
    en: { tag: "ELECTRONICS", title: "Electronic Fault & Repair", text: "Maintenance and repair for televisions, satellite receivers, sound systems and more.", issues: ["Television fault", "Satellite receiver fault", "Sound system fault", "Other electronic fault"] },
  },
  {
...
const copy = {
  tr: {
    ...
    professional: "PROFESYONEL HİZMET", heroA: "Arızanız beklemez.", heroB: "Biz de.", heroLead: "Sincan merkezli ekibimizle Ankara genelinde; elektronikten kombiye, su tesisatından petek bakımına hızlı teşhis ve özenli çalışma.", quote: "FİYAT AL", viewServices: "HİZMETLERİ İNCELE",
  ...
  en: {
    ...
    professional: "PROFESSIONAL SERVICE", heroA: "Your repair can’t wait.", heroB: "Neither do we.", heroLead: "Fast diagnosis and careful workmanship for electronics, boilers, radiators and plumbing throughout your home.", quote: "GET A QUOTE", viewServices: "VIEW SERVICES",
    ...
    localKicker: "ON-SITE SERVICE IN ANKARA", localTitle: "Technical support across Ankara from Sincan.", localText: "We evaluate service requests across Ankara for electronics, small appliances, boiler care, radiator cleaning and plumbing.", districts: ["Sincan", "Etimesgut", "Yenimahalle", "Keçiören", "Çankaya", "Mamak", "Pursaklar", "Gölbaşı"], faqTitle: "Frequently asked questions", faq: [["Which areas do you serve?", "Based in Sincan, we evaluate service requests throughout Ankara. You can send your district and address through WhatsApp."], ["When does a call-out fee apply?", "A call-out fee applies for fault diagnosis. It is waived when we complete the repair under our guarantee."], ["How can I request a quote?", "Choose the service and fault type in the WhatsApp service assistant, then send your details for a request-specific quote."], ["Can I send photos or video?", "Yes. After creating your request, you can send photos and videos of the appliance or fault through WhatsApp."]],
    ...
    footerSlogan: "Dependable technical support for your home.", footerText: "Fast and careful solutions for electronics, small appliances, boilers, radiators and plumbing. Our Sincan-based team provides on-site service throughout Ankara. We work with clear communication and a lasting-solution approach.", ourServices: "Our Services", contactUpper: "CONTACT", serviceArea: "On-site service throughout Ankara.", rights: "All Rights Reserved.", backTop: "BACK TO TOP",
    ticker: ["FAULT DIAGNOSIS", "ELECTRONIC REPAIR", "SMALL APPLIANCES", "BOILER CARE", "RADIATOR CLEANING", "WATER LEAKS", "BLOCKAGE REMOVAL", "Fast diagnosis, careful workmanship, dependable service"],
    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-visual" aria-label={t.services}>
          ...
          <div className="hero-service-art"><img src="/assets/kare-efekt-960.webp" srcSet="/assets/kare-efekt-640.webp 640w, /assets/kare-efekt-960.webp 960w, /assets/kare-efekt.webp 1415w" sizes="(max-width: 820px) 100vw, 55vw" alt="Ankara'da elektronik, kombi, petek ve su tesisatı teknik servisi" width="1415" height="1112" decoding="async" fetchPriority="high" /></div>
      ...
      <div className={`a11y-widget${a11yDockRight ? " dock-right" : ""}`} style={{ left: a11yPosition.x, top: a11yPosition.y }}>
        ...
        {a11yOpen && <section className="a11y-panel" role="dialog" aria-label={t.a11y.menu}>
          <div className="a11y-panel-head"><strong>{t.a11y.menu}</strong><button type="button" onClick={() => setA11yOpen(false)} aria-label={t.chat.close}><X aria-hidden="true" /></button></div>
